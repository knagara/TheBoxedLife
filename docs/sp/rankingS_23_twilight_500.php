...
<title>失われゆく情熱 夕暮れを漫歩く スコアランキング | 窮屈な人生 Androidゲームアプリ | クックソニア</title>
...
<h2>失われゆく情熱　夕暮れを漫歩く<br>スコアランキング</h2>
<div id="wrap">
	<table>
...
<?php
$rank=1;
$result = mysql_query("select * from $table order by score desc, id asc LIMIT 500");
...
<!-- ここまで -->
    ...
    <br>
	<br>
  <p><a href="rankingS_23_twilight.php">戻る</a><!--　　<a style="color:#2D3032;" href="rankingS2_1000.php">1000位まで表示</a>--></p>
