...
<div id="wrap">
	...
	<div id="aoy" style="margin:-25px 15px 30px;background:#000000;color:#f0f0f0;padding:10px 10px 20px;">
		<p><b>アプリ・オブ・ザ・イヤー2012</b>最優秀賞を受賞しました！</p>
		<p style="text-align:center"><a class="css3buttonRed" style="" href="http://appget.com/c/aoy/12802/aoy2012result/">特設ページへ</a></p>
	</div>
    <div class="app">
        <div class="appTitle">
    ...
    <div class="app">
        ...
        <?php
		  ...
		  if($browser == 'iphone'){
            ...
            <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://bit.ly/WhZoqk" data-text="無敵のキヨサキ - iPhone/iPadアプリ" data-via="Cooksonian" data-lang="ja" data-hashtags="appjp">ツイート</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
