...
<title>ステージ28 | 窮屈な人生 Androidゲームアプリ | クックソニア</title>
...
<div id="wrap">
	<table>
		<tr id="tr_top"><td class="t_rank">id</td><td class="t_score">s</td><td class="t_name">n</td><td class="t_comment">ideas</td></tr>

<!-- ここからPHPでデータベースに接続、結果を表示 -->
<?php
$rank=1;
$result = mysql_query("select * from $table order by score desc, id asc limit 1000 offset 1000");
