...
<title>隠しステージ１ スコアランキング | 窮屈な人生 Androidゲームアプリ | クックソニア</title>
...
<h2>隠しステージ１ スコアランキング</h2>
<div id="wrap">
	<p style="font-size:80%;text-align:left;">バグ修正に伴い、ランキングをリセットしました。<br>以前までのランキングは<a href="ranking1.php">こちら</a>で見れます。</p>
	<table>
...
<!-- ここまで -->
  ...
  <br>
  <div id="notice">
  <p>※スコアが同じ場合、先にスコアを送信した方の順位が上になります。</p>
  </div>
  <br>
  <p><a style="color:#2D3032;" href="ranking1_fix_100.php">200位まで表示</a></p>
</div>
<footer>
...
-->
  <br>
  <p><a href="ranking2.php">隠しステージ２スコアランキング</a></p>
  <br>
  <p><a href="./">トップヘ戻る</a></p>
  <br>
